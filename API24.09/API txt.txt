...
Meu primeiro passo foi criar uma Pasta, que denominei API24.09, no meu Desktop e nela armazenar os arquivos.
...
Depois baixei o arquivo Zip do professor na minha Pasta (API24.09) para fazer um paralelo do meu projeto com o projeto do professor.

Em sequência, com o GitHub aberto, criei um novo Repositório para abrigar as tarefas acima mencionadas.
